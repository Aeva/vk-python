...
vkEnumerateInstanceExtensionProperties.argtypes = [ctypes.POINTER(ctypes.c_char), ctypes.POINTER(ctypes.c_uint32), ctypes.POINTER(VkExtensionProperties)]
...
vkEnumerateDeviceExtensionProperties.argtypes = [VkPhysicalDevice, ctypes.POINTER(ctypes.c_char), ctypes.POINTER(ctypes.c_uint32), ctypes.POINTER(VkExtensionProperties)]
...
vkCmdBeginConditionalRenderingEXT = VK_DLL.vkCmdBeginConditionalRenderingEXT
vkCmdBeginConditionalRenderingEXT.restype = None
vkCmdBeginConditionalRenderingEXT.argtypes = [VkCommandBuffer, ctypes.POINTER(VkConditionalRenderingBeginInfoEXT)]
vkCmdEndConditionalRenderingEXT = VK_DLL.vkCmdEndConditionalRenderingEXT
...
if VK_USE_PLATFORM_ANDROID_KHR:
    vkCreateAndroidSurfaceKHR = VK_DLL.vkCreateAndroidSurfaceKHR
    vkCreateAndroidSurfaceKHR.restype = VkResult
    vkCreateAndroidSurfaceKHR.argtypes = [VkInstance, ctypes.POINTER(VkAndroidSurfaceCreateInfoKHR), ctypes.POINTER(VkAllocationCallbacks), ctypes.POINTER(VkSurfaceKHR)]
vkGetPhysicalDeviceDisplayPropertiesKHR = VK_DLL.vkGetPhysicalDeviceDisplayPropertiesKHR
vkGetPhysicalDeviceDisplayPropertiesKHR.restype = VkResult
vkGetPhysicalDeviceDisplayPropertiesKHR.argtypes = [VkPhysicalDevice, ctypes.POINTER(ctypes.c_uint32), ctypes.POINTER(VkDisplayPropertiesKHR)]
vkGetPhysicalDeviceDisplayPlanePropertiesKHR = VK_DLL.vkGetPhysicalDeviceDisplayPlanePropertiesKHR
vkGetPhysicalDeviceDisplayPlanePropertiesKHR.restype = VkResult
vkGetPhysicalDeviceDisplayPlanePropertiesKHR.argtypes = [VkPhysicalDevice, ctypes.POINTER(ctypes.c_uint32), ctypes.POINTER(VkDisplayPlanePropertiesKHR)]
vkGetDisplayPlaneSupportedDisplaysKHR = VK_DLL.vkGetDisplayPlaneSupportedDisplaysKHR
vkGetDisplayPlaneSupportedDisplaysKHR.restype = VkResult
vkGetDisplayPlaneSupportedDisplaysKHR.argtypes = [VkPhysicalDevice, ctypes.c_uint32, ctypes.POINTER(ctypes.c_uint32), ctypes.POINTER(VkDisplayKHR)]
vkGetDisplayModePropertiesKHR = VK_DLL.vkGetDisplayModePropertiesKHR
vkGetDisplayModePropertiesKHR.restype = VkResult
vkGetDisplayModePropertiesKHR.argtypes = [VkPhysicalDevice, VkDisplayKHR, ctypes.POINTER(ctypes.c_uint32), ctypes.POINTER(VkDisplayModePropertiesKHR)]
vkCreateDisplayModeKHR = VK_DLL.vkCreateDisplayModeKHR
vkCreateDisplayModeKHR.restype = VkResult
vkCreateDisplayModeKHR.argtypes = [VkPhysicalDevice, VkDisplayKHR, ctypes.POINTER(VkDisplayModeCreateInfoKHR), ctypes.POINTER(VkAllocationCallbacks), ctypes.POINTER(VkDisplayModeKHR)]
vkGetDisplayPlaneCapabilitiesKHR = VK_DLL.vkGetDisplayPlaneCapabilitiesKHR
vkGetDisplayPlaneCapabilitiesKHR.restype = VkResult
vkGetDisplayPlaneCapabilitiesKHR.argtypes = [VkPhysicalDevice, VkDisplayModeKHR, ctypes.c_uint32, ctypes.POINTER(VkDisplayPlaneCapabilitiesKHR)]
vkCreateDisplayPlaneSurfaceKHR = VK_DLL.vkCreateDisplayPlaneSurfaceKHR
vkCreateDisplayPlaneSurfaceKHR.restype = VkResult
vkCreateDisplayPlaneSurfaceKHR.argtypes = [VkInstance, ctypes.POINTER(VkDisplaySurfaceCreateInfoKHR), ctypes.POINTER(VkAllocationCallbacks), ctypes.POINTER(VkSurfaceKHR)]
vkCreateSharedSwapchainsKHR = VK_DLL.vkCreateSharedSwapchainsKHR
vkCreateSharedSwapchainsKHR.restype = VkResult
vkCreateSharedSwapchainsKHR.argtypes = [VkDevice, ctypes.c_uint32, ctypes.POINTER(VkSwapchainCreateInfoKHR), ctypes.POINTER(VkAllocationCallbacks), ctypes.POINTER(VkSwapchainKHR)]
vkDestroySurfaceKHR = VK_DLL.vkDestroySurfaceKHR
vkDestroySurfaceKHR.restype = None
vkDestroySurfaceKHR.argtypes = [VkInstance, VkSurfaceKHR, ctypes.POINTER(VkAllocationCallbacks)]
vkGetPhysicalDeviceSurfaceSupportKHR = VK_DLL.vkGetPhysicalDeviceSurfaceSupportKHR
vkGetPhysicalDeviceSurfaceSupportKHR.restype = VkResult
vkGetPhysicalDeviceSurfaceSupportKHR.argtypes = [VkPhysicalDevice, ctypes.c_uint32, VkSurfaceKHR, ctypes.POINTER(VkBool32)]
vkGetPhysicalDeviceSurfaceCapabilitiesKHR = VK_DLL.vkGetPhysicalDeviceSurfaceCapabilitiesKHR
vkGetPhysicalDeviceSurfaceCapabilitiesKHR.restype = VkResult
vkGetPhysicalDeviceSurfaceCapabilitiesKHR.argtypes = [VkPhysicalDevice, VkSurfaceKHR, ctypes.POINTER(VkSurfaceCapabilitiesKHR)]
vkGetPhysicalDeviceSurfaceFormatsKHR = VK_DLL.vkGetPhysicalDeviceSurfaceFormatsKHR
vkGetPhysicalDeviceSurfaceFormatsKHR.restype = VkResult
vkGetPhysicalDeviceSurfaceFormatsKHR.argtypes = [VkPhysicalDevice, VkSurfaceKHR, ctypes.POINTER(ctypes.c_uint32), ctypes.POINTER(VkSurfaceFormatKHR)]
vkGetPhysicalDeviceSurfacePresentModesKHR = VK_DLL.vkGetPhysicalDeviceSurfacePresentModesKHR
...
vkCreateSwapchainKHR = VK_DLL.vkCreateSwapchainKHR
vkCreateSwapchainKHR.restype = VkResult
vkCreateSwapchainKHR.argtypes = [VkDevice, ctypes.POINTER(VkSwapchainCreateInfoKHR), ctypes.POINTER(VkAllocationCallbacks), ctypes.POINTER(VkSwapchainKHR)]
vkDestroySwapchainKHR = VK_DLL.vkDestroySwapchainKHR
vkDestroySwapchainKHR.restype = None
vkDestroySwapchainKHR.argtypes = [VkDevice, VkSwapchainKHR, ctypes.POINTER(VkAllocationCallbacks)]
vkGetSwapchainImagesKHR = VK_DLL.vkGetSwapchainImagesKHR
vkGetSwapchainImagesKHR.restype = VkResult
vkGetSwapchainImagesKHR.argtypes = [VkDevice, VkSwapchainKHR, ctypes.POINTER(ctypes.c_uint32), ctypes.POINTER(VkImage)]
vkAcquireNextImageKHR = VK_DLL.vkAcquireNextImageKHR
vkAcquireNextImageKHR.restype = VkResult
vkAcquireNextImageKHR.argtypes = [VkDevice, VkSwapchainKHR, ctypes.c_uint64, VkSemaphore, VkFence, ctypes.POINTER(ctypes.c_uint32)]
vkQueuePresentKHR = VK_DLL.vkQueuePresentKHR
vkQueuePresentKHR.restype = VkResult
vkQueuePresentKHR.argtypes = [VkQueue, ctypes.POINTER(VkPresentInfoKHR)]
if VK_USE_PLATFORM_VI_NN:
    vkCreateViSurfaceNN = VK_DLL.vkCreateViSurfaceNN
    vkCreateViSurfaceNN.restype = VkResult
    vkCreateViSurfaceNN.argtypes = [VkInstance, ctypes.POINTER(VkViSurfaceCreateInfoNN), ctypes.POINTER(VkAllocationCallbacks), ctypes.POINTER(VkSurfaceKHR)]
if VK_USE_PLATFORM_WAYLAND_KHR:
    vkCreateWaylandSurfaceKHR = VK_DLL.vkCreateWaylandSurfaceKHR
    vkCreateWaylandSurfaceKHR.restype = VkResult
    vkCreateWaylandSurfaceKHR.argtypes = [VkInstance, ctypes.POINTER(VkWaylandSurfaceCreateInfoKHR), ctypes.POINTER(VkAllocationCallbacks), ctypes.POINTER(VkSurfaceKHR)]
if VK_USE_PLATFORM_WAYLAND_KHR:
    vkGetPhysicalDeviceWaylandPresentationSupportKHR = VK_DLL.vkGetPhysicalDeviceWaylandPresentationSupportKHR
    vkGetPhysicalDeviceWaylandPresentationSupportKHR.restype = VkBool32
    vkGetPhysicalDeviceWaylandPresentationSupportKHR.argtypes = [VkPhysicalDevice, ctypes.c_uint32, ctypes.POINTER(wl_display)]
if VK_USE_PLATFORM_WIN32_KHR:
    vkCreateWin32SurfaceKHR = VK_DLL.vkCreateWin32SurfaceKHR
    vkCreateWin32SurfaceKHR.restype = VkResult
    vkCreateWin32SurfaceKHR.argtypes = [VkInstance, ctypes.POINTER(VkWin32SurfaceCreateInfoKHR), ctypes.POINTER(VkAllocationCallbacks), ctypes.POINTER(VkSurfaceKHR)]
if VK_USE_PLATFORM_WIN32_KHR:
    vkGetPhysicalDeviceWin32PresentationSupportKHR = VK_DLL.vkGetPhysicalDeviceWin32PresentationSupportKHR
    vkGetPhysicalDeviceWin32PresentationSupportKHR.restype = VkBool32
    vkGetPhysicalDeviceWin32PresentationSupportKHR.argtypes = [VkPhysicalDevice, ctypes.c_uint32]
if VK_USE_PLATFORM_XLIB_KHR:
    vkCreateXlibSurfaceKHR = VK_DLL.vkCreateXlibSurfaceKHR
    vkCreateXlibSurfaceKHR.restype = VkResult
    vkCreateXlibSurfaceKHR.argtypes = [VkInstance, ctypes.POINTER(VkXlibSurfaceCreateInfoKHR), ctypes.POINTER(VkAllocationCallbacks), ctypes.POINTER(VkSurfaceKHR)]
if VK_USE_PLATFORM_XLIB_KHR:
    vkGetPhysicalDeviceXlibPresentationSupportKHR = VK_DLL.vkGetPhysicalDeviceXlibPresentationSupportKHR
    vkGetPhysicalDeviceXlibPresentationSupportKHR.restype = VkBool32
    vkGetPhysicalDeviceXlibPresentationSupportKHR.argtypes = [VkPhysicalDevice, ctypes.c_uint32, ctypes.POINTER(Display), VisualID]
if VK_USE_PLATFORM_XCB_KHR:
    vkCreateXcbSurfaceKHR = VK_DLL.vkCreateXcbSurfaceKHR
    vkCreateXcbSurfaceKHR.restype = VkResult
    vkCreateXcbSurfaceKHR.argtypes = [VkInstance, ctypes.POINTER(VkXcbSurfaceCreateInfoKHR), ctypes.POINTER(VkAllocationCallbacks), ctypes.POINTER(VkSurfaceKHR)]
if VK_USE_PLATFORM_XCB_KHR:
    vkGetPhysicalDeviceXcbPresentationSupportKHR = VK_DLL.vkGetPhysicalDeviceXcbPresentationSupportKHR
    vkGetPhysicalDeviceXcbPresentationSupportKHR.restype = VkBool32
    vkGetPhysicalDeviceXcbPresentationSupportKHR.argtypes = [VkPhysicalDevice, ctypes.c_uint32, ctypes.POINTER(xcb_connection_t), xcb_visualid_t]
if VK_USE_PLATFORM_DIRECTFB_EXT:
    vkCreateDirectFBSurfaceEXT = VK_DLL.vkCreateDirectFBSurfaceEXT
    vkCreateDirectFBSurfaceEXT.restype = VkResult
    vkCreateDirectFBSurfaceEXT.argtypes = [VkInstance, ctypes.POINTER(VkDirectFBSurfaceCreateInfoEXT), ctypes.POINTER(VkAllocationCallbacks), ctypes.POINTER(VkSurfaceKHR)]
if VK_USE_PLATFORM_DIRECTFB_EXT:
    vkGetPhysicalDeviceDirectFBPresentationSupportEXT = VK_DLL.vkGetPhysicalDeviceDirectFBPresentationSupportEXT
    vkGetPhysicalDeviceDirectFBPresentationSupportEXT.restype = VkBool32
    vkGetPhysicalDeviceDirectFBPresentationSupportEXT.argtypes = [VkPhysicalDevice, ctypes.c_uint32, ctypes.POINTER(IDirectFB)]
if VK_USE_PLATFORM_FUCHSIA:
    vkCreateImagePipeSurfaceFUCHSIA = VK_DLL.vkCreateImagePipeSurfaceFUCHSIA
    vkCreateImagePipeSurfaceFUCHSIA.restype = VkResult
    vkCreateImagePipeSurfaceFUCHSIA.argtypes = [VkInstance, ctypes.POINTER(VkImagePipeSurfaceCreateInfoFUCHSIA), ctypes.POINTER(VkAllocationCallbacks), ctypes.POINTER(VkSurfaceKHR)]
if VK_USE_PLATFORM_GGP:
    vkCreateStreamDescriptorSurfaceGGP = VK_DLL.vkCreateStreamDescriptorSurfaceGGP
    vkCreateStreamDescriptorSurfaceGGP.restype = VkResult
    vkCreateStreamDescriptorSurfaceGGP.argtypes = [VkInstance, ctypes.POINTER(VkStreamDescriptorSurfaceCreateInfoGGP), ctypes.POINTER(VkAllocationCallbacks), ctypes.POINTER(VkSurfaceKHR)]
vkCreateDebugReportCallbackEXT = VK_DLL.vkCreateDebugReportCallbackEXT
vkCreateDebugReportCallbackEXT.restype = VkResult
vkCreateDebugReportCallbackEXT.argtypes = [VkInstance, ctypes.POINTER(VkDebugReportCallbackCreateInfoEXT), ctypes.POINTER(VkAllocationCallbacks), ctypes.POINTER(VkDebugReportCallbackEXT)]
vkDestroyDebugReportCallbackEXT = VK_DLL.vkDestroyDebugReportCallbackEXT
vkDestroyDebugReportCallbackEXT.restype = None
vkDestroyDebugReportCallbackEXT.argtypes = [VkInstance, VkDebugReportCallbackEXT, ctypes.POINTER(VkAllocationCallbacks)]
vkDebugReportMessageEXT = VK_DLL.vkDebugReportMessageEXT
vkDebugReportMessageEXT.restype = None
vkDebugReportMessageEXT.argtypes = [VkInstance, VkDebugReportFlagsEXT, VkDebugReportObjectTypeEXT, ctypes.c_uint64, ctypes.c_size_t, ctypes.c_int32, ctypes.POINTER(ctypes.c_char), ctypes.POINTER(ctypes.c_char)]
vkDebugMarkerSetObjectNameEXT = VK_DLL.vkDebugMarkerSetObjectNameEXT
vkDebugMarkerSetObjectNameEXT.restype = VkResult
vkDebugMarkerSetObjectNameEXT.argtypes = [VkDevice, ctypes.POINTER(VkDebugMarkerObjectNameInfoEXT)]
vkDebugMarkerSetObjectTagEXT = VK_DLL.vkDebugMarkerSetObjectTagEXT
vkDebugMarkerSetObjectTagEXT.restype = VkResult
vkDebugMarkerSetObjectTagEXT.argtypes = [VkDevice, ctypes.POINTER(VkDebugMarkerObjectTagInfoEXT)]
vkCmdDebugMarkerBeginEXT = VK_DLL.vkCmdDebugMarkerBeginEXT
vkCmdDebugMarkerBeginEXT.restype = None
vkCmdDebugMarkerBeginEXT.argtypes = [VkCommandBuffer, ctypes.POINTER(VkDebugMarkerMarkerInfoEXT)]
vkCmdDebugMarkerEndEXT = VK_DLL.vkCmdDebugMarkerEndEXT
vkCmdDebugMarkerEndEXT.restype = None
vkCmdDebugMarkerEndEXT.argtypes = [VkCommandBuffer]
vkCmdDebugMarkerInsertEXT = VK_DLL.vkCmdDebugMarkerInsertEXT
vkCmdDebugMarkerInsertEXT.restype = None
vkCmdDebugMarkerInsertEXT.argtypes = [VkCommandBuffer, ctypes.POINTER(VkDebugMarkerMarkerInfoEXT)]
vkGetPhysicalDeviceExternalImageFormatPropertiesNV = VK_DLL.vkGetPhysicalDeviceExternalImageFormatPropertiesNV
vkGetPhysicalDeviceExternalImageFormatPropertiesNV.restype = VkResult
vkGetPhysicalDeviceExternalImageFormatPropertiesNV.argtypes = [VkPhysicalDevice, VkFormat, VkImageType, VkImageTiling, VkImageUsageFlags, VkImageCreateFlags, VkExternalMemoryHandleTypeFlagsNV, ctypes.POINTER(VkExternalImageFormatPropertiesNV)]
if VK_USE_PLATFORM_WIN32_KHR:
    vkGetMemoryWin32HandleNV = VK_DLL.vkGetMemoryWin32HandleNV
    vkGetMemoryWin32HandleNV.restype = VkResult
    vkGetMemoryWin32HandleNV.argtypes = [VkDevice, VkDeviceMemory, VkExternalMemoryHandleTypeFlagsNV, ctypes.POINTER(ctypes.wintypes.HANDLE)]
vkCmdExecuteGeneratedCommandsNV = VK_DLL.vkCmdExecuteGeneratedCommandsNV
vkCmdExecuteGeneratedCommandsNV.restype = None
vkCmdExecuteGeneratedCommandsNV.argtypes = [VkCommandBuffer, VkBool32, ctypes.POINTER(VkGeneratedCommandsInfoNV)]
vkCmdPreprocessGeneratedCommandsNV = VK_DLL.vkCmdPreprocessGeneratedCommandsNV
vkCmdPreprocessGeneratedCommandsNV.restype = None
vkCmdPreprocessGeneratedCommandsNV.argtypes = [VkCommandBuffer, ctypes.POINTER(VkGeneratedCommandsInfoNV)]
vkCmdBindPipelineShaderGroupNV = VK_DLL.vkCmdBindPipelineShaderGroupNV
vkCmdBindPipelineShaderGroupNV.restype = None
vkCmdBindPipelineShaderGroupNV.argtypes = [VkCommandBuffer, VkPipelineBindPoint, VkPipeline, ctypes.c_uint32]
vkGetGeneratedCommandsMemoryRequirementsNV = VK_DLL.vkGetGeneratedCommandsMemoryRequirementsNV
vkGetGeneratedCommandsMemoryRequirementsNV.restype = None
vkGetGeneratedCommandsMemoryRequirementsNV.argtypes = [VkDevice, ctypes.POINTER(VkGeneratedCommandsMemoryRequirementsInfoNV), ctypes.POINTER(VkMemoryRequirements2)]
vkCreateIndirectCommandsLayoutNV = VK_DLL.vkCreateIndirectCommandsLayoutNV
vkCreateIndirectCommandsLayoutNV.restype = VkResult
vkCreateIndirectCommandsLayoutNV.argtypes = [VkDevice, ctypes.POINTER(VkIndirectCommandsLayoutCreateInfoNV), ctypes.POINTER(VkAllocationCallbacks), ctypes.POINTER(VkIndirectCommandsLayoutNV)]
vkDestroyIndirectCommandsLayoutNV = VK_DLL.vkDestroyIndirectCommandsLayoutNV
vkDestroyIndirectCommandsLayoutNV.restype = None
vkDestroyIndirectCommandsLayoutNV.argtypes = [VkDevice, VkIndirectCommandsLayoutNV, ctypes.POINTER(VkAllocationCallbacks)]
...
vkCmdPushDescriptorSetKHR = VK_DLL.vkCmdPushDescriptorSetKHR
vkCmdPushDescriptorSetKHR.restype = None
vkCmdPushDescriptorSetKHR.argtypes = [VkCommandBuffer, VkPipelineBindPoint, VkPipelineLayout, ctypes.c_uint32, ctypes.c_uint32, ctypes.POINTER(VkWriteDescriptorSet)]
...
if VK_USE_PLATFORM_WIN32_KHR:
    vkGetMemoryWin32HandleKHR = VK_DLL.vkGetMemoryWin32HandleKHR
    vkGetMemoryWin32HandleKHR.restype = VkResult
    vkGetMemoryWin32HandleKHR.argtypes = [VkDevice, ctypes.POINTER(VkMemoryGetWin32HandleInfoKHR), ctypes.POINTER(ctypes.wintypes.HANDLE)]
if VK_USE_PLATFORM_WIN32_KHR:
    vkGetMemoryWin32HandlePropertiesKHR = VK_DLL.vkGetMemoryWin32HandlePropertiesKHR
    vkGetMemoryWin32HandlePropertiesKHR.restype = VkResult
    vkGetMemoryWin32HandlePropertiesKHR.argtypes = [VkDevice, VkExternalMemoryHandleTypeFlagBits, ctypes.wintypes.HANDLE, ctypes.POINTER(VkMemoryWin32HandlePropertiesKHR)]
vkGetMemoryFdKHR = VK_DLL.vkGetMemoryFdKHR
vkGetMemoryFdKHR.restype = VkResult
vkGetMemoryFdKHR.argtypes = [VkDevice, ctypes.POINTER(VkMemoryGetFdInfoKHR), ctypes.POINTER(ctypes.c_int)]
vkGetMemoryFdPropertiesKHR = VK_DLL.vkGetMemoryFdPropertiesKHR
vkGetMemoryFdPropertiesKHR.restype = VkResult
vkGetMemoryFdPropertiesKHR.argtypes = [VkDevice, VkExternalMemoryHandleTypeFlagBits, ctypes.c_int, ctypes.POINTER(VkMemoryFdPropertiesKHR)]
...
if VK_USE_PLATFORM_WIN32_KHR:
    vkGetSemaphoreWin32HandleKHR = VK_DLL.vkGetSemaphoreWin32HandleKHR
    vkGetSemaphoreWin32HandleKHR.restype = VkResult
    vkGetSemaphoreWin32HandleKHR.argtypes = [VkDevice, ctypes.POINTER(VkSemaphoreGetWin32HandleInfoKHR), ctypes.POINTER(ctypes.wintypes.HANDLE)]
if VK_USE_PLATFORM_WIN32_KHR:
    vkImportSemaphoreWin32HandleKHR = VK_DLL.vkImportSemaphoreWin32HandleKHR
    vkImportSemaphoreWin32HandleKHR.restype = VkResult
    vkImportSemaphoreWin32HandleKHR.argtypes = [VkDevice, ctypes.POINTER(VkImportSemaphoreWin32HandleInfoKHR)]
vkGetSemaphoreFdKHR = VK_DLL.vkGetSemaphoreFdKHR
vkGetSemaphoreFdKHR.restype = VkResult
vkGetSemaphoreFdKHR.argtypes = [VkDevice, ctypes.POINTER(VkSemaphoreGetFdInfoKHR), ctypes.POINTER(ctypes.c_int)]
vkImportSemaphoreFdKHR = VK_DLL.vkImportSemaphoreFdKHR
vkImportSemaphoreFdKHR.restype = VkResult
vkImportSemaphoreFdKHR.argtypes = [VkDevice, ctypes.POINTER(VkImportSemaphoreFdInfoKHR)]
...
if VK_USE_PLATFORM_WIN32_KHR:
    vkGetFenceWin32HandleKHR = VK_DLL.vkGetFenceWin32HandleKHR
    vkGetFenceWin32HandleKHR.restype = VkResult
    vkGetFenceWin32HandleKHR.argtypes = [VkDevice, ctypes.POINTER(VkFenceGetWin32HandleInfoKHR), ctypes.POINTER(ctypes.wintypes.HANDLE)]
if VK_USE_PLATFORM_WIN32_KHR:
    vkImportFenceWin32HandleKHR = VK_DLL.vkImportFenceWin32HandleKHR
    vkImportFenceWin32HandleKHR.restype = VkResult
    vkImportFenceWin32HandleKHR.argtypes = [VkDevice, ctypes.POINTER(VkImportFenceWin32HandleInfoKHR)]
vkGetFenceFdKHR = VK_DLL.vkGetFenceFdKHR
vkGetFenceFdKHR.restype = VkResult
vkGetFenceFdKHR.argtypes = [VkDevice, ctypes.POINTER(VkFenceGetFdInfoKHR), ctypes.POINTER(ctypes.c_int)]
vkImportFenceFdKHR = VK_DLL.vkImportFenceFdKHR
vkImportFenceFdKHR.restype = VkResult
vkImportFenceFdKHR.argtypes = [VkDevice, ctypes.POINTER(VkImportFenceFdInfoKHR)]
vkReleaseDisplayEXT = VK_DLL.vkReleaseDisplayEXT
...
if VK_USE_PLATFORM_XLIB_XRANDR_EXT:
    vkAcquireXlibDisplayEXT = VK_DLL.vkAcquireXlibDisplayEXT
    vkAcquireXlibDisplayEXT.restype = VkResult
    vkAcquireXlibDisplayEXT.argtypes = [VkPhysicalDevice, ctypes.POINTER(Display), VkDisplayKHR]
if VK_USE_PLATFORM_XLIB_XRANDR_EXT:
    vkGetRandROutputDisplayEXT = VK_DLL.vkGetRandROutputDisplayEXT
    vkGetRandROutputDisplayEXT.restype = VkResult
    vkGetRandROutputDisplayEXT.argtypes = [VkPhysicalDevice, ctypes.POINTER(Display), RROutput, ctypes.POINTER(VkDisplayKHR)]
vkDisplayPowerControlEXT = VK_DLL.vkDisplayPowerControlEXT
vkDisplayPowerControlEXT.restype = VkResult
vkDisplayPowerControlEXT.argtypes = [VkDevice, VkDisplayKHR, ctypes.POINTER(VkDisplayPowerInfoEXT)]
vkRegisterDeviceEventEXT = VK_DLL.vkRegisterDeviceEventEXT
vkRegisterDeviceEventEXT.restype = VkResult
vkRegisterDeviceEventEXT.argtypes = [VkDevice, ctypes.POINTER(VkDeviceEventInfoEXT), ctypes.POINTER(VkAllocationCallbacks), ctypes.POINTER(VkFence)]
vkRegisterDisplayEventEXT = VK_DLL.vkRegisterDisplayEventEXT
vkRegisterDisplayEventEXT.restype = VkResult
vkRegisterDisplayEventEXT.argtypes = [VkDevice, VkDisplayKHR, ctypes.POINTER(VkDisplayEventInfoEXT), ctypes.POINTER(VkAllocationCallbacks), ctypes.POINTER(VkFence)]
vkGetSwapchainCounterEXT = VK_DLL.vkGetSwapchainCounterEXT
...
vkGetPhysicalDeviceSurfaceCapabilities2EXT = VK_DLL.vkGetPhysicalDeviceSurfaceCapabilities2EXT
vkGetPhysicalDeviceSurfaceCapabilities2EXT.restype = VkResult
vkGetPhysicalDeviceSurfaceCapabilities2EXT.argtypes = [VkPhysicalDevice, VkSurfaceKHR, ctypes.POINTER(VkSurfaceCapabilities2EXT)]
...
vkGetDeviceGroupPresentCapabilitiesKHR = VK_DLL.vkGetDeviceGroupPresentCapabilitiesKHR
vkGetDeviceGroupPresentCapabilitiesKHR.restype = VkResult
vkGetDeviceGroupPresentCapabilitiesKHR.argtypes = [VkDevice, ctypes.POINTER(VkDeviceGroupPresentCapabilitiesKHR)]
vkGetDeviceGroupSurfacePresentModesKHR = VK_DLL.vkGetDeviceGroupSurfacePresentModesKHR
vkGetDeviceGroupSurfacePresentModesKHR.restype = VkResult
vkGetDeviceGroupSurfacePresentModesKHR.argtypes = [VkDevice, VkSurfaceKHR, ctypes.POINTER(VkDeviceGroupPresentModeFlagsKHR)]
vkAcquireNextImage2KHR = VK_DLL.vkAcquireNextImage2KHR
vkAcquireNextImage2KHR.restype = VkResult
vkAcquireNextImage2KHR.argtypes = [VkDevice, ctypes.POINTER(VkAcquireNextImageInfoKHR), ctypes.POINTER(ctypes.c_uint32)]
...
vkGetPhysicalDevicePresentRectanglesKHR = VK_DLL.vkGetPhysicalDevicePresentRectanglesKHR
vkGetPhysicalDevicePresentRectanglesKHR.restype = VkResult
vkGetPhysicalDevicePresentRectanglesKHR.argtypes = [VkPhysicalDevice, VkSurfaceKHR, ctypes.POINTER(ctypes.c_uint32), ctypes.POINTER(VkRect2D)]
...
vkCmdPushDescriptorSetWithTemplateKHR = VK_DLL.vkCmdPushDescriptorSetWithTemplateKHR
vkCmdPushDescriptorSetWithTemplateKHR.restype = None
vkCmdPushDescriptorSetWithTemplateKHR.argtypes = [VkCommandBuffer, VkDescriptorUpdateTemplate, VkPipelineLayout, ctypes.c_uint32, ctypes.c_void_p]
vkSetHdrMetadataEXT = VK_DLL.vkSetHdrMetadataEXT
vkSetHdrMetadataEXT.restype = None
vkSetHdrMetadataEXT.argtypes = [VkDevice, ctypes.c_uint32, ctypes.POINTER(VkSwapchainKHR), ctypes.POINTER(VkHdrMetadataEXT)]
vkGetSwapchainStatusKHR = VK_DLL.vkGetSwapchainStatusKHR
vkGetSwapchainStatusKHR.restype = VkResult
vkGetSwapchainStatusKHR.argtypes = [VkDevice, VkSwapchainKHR]
vkGetRefreshCycleDurationGOOGLE = VK_DLL.vkGetRefreshCycleDurationGOOGLE
vkGetRefreshCycleDurationGOOGLE.restype = VkResult
vkGetRefreshCycleDurationGOOGLE.argtypes = [VkDevice, VkSwapchainKHR, ctypes.POINTER(VkRefreshCycleDurationGOOGLE)]
vkGetPastPresentationTimingGOOGLE = VK_DLL.vkGetPastPresentationTimingGOOGLE
vkGetPastPresentationTimingGOOGLE.restype = VkResult
vkGetPastPresentationTimingGOOGLE.argtypes = [VkDevice, VkSwapchainKHR, ctypes.POINTER(ctypes.c_uint32), ctypes.POINTER(VkPastPresentationTimingGOOGLE)]
if VK_USE_PLATFORM_IOS_MVK:
    vkCreateIOSSurfaceMVK = VK_DLL.vkCreateIOSSurfaceMVK
    vkCreateIOSSurfaceMVK.restype = VkResult
    vkCreateIOSSurfaceMVK.argtypes = [VkInstance, ctypes.POINTER(VkIOSSurfaceCreateInfoMVK), ctypes.POINTER(VkAllocationCallbacks), ctypes.POINTER(VkSurfaceKHR)]
if VK_USE_PLATFORM_MACOS_MVK:
    vkCreateMacOSSurfaceMVK = VK_DLL.vkCreateMacOSSurfaceMVK
    vkCreateMacOSSurfaceMVK.restype = VkResult
    vkCreateMacOSSurfaceMVK.argtypes = [VkInstance, ctypes.POINTER(VkMacOSSurfaceCreateInfoMVK), ctypes.POINTER(VkAllocationCallbacks), ctypes.POINTER(VkSurfaceKHR)]
if VK_USE_PLATFORM_METAL_EXT:
    vkCreateMetalSurfaceEXT = VK_DLL.vkCreateMetalSurfaceEXT
    vkCreateMetalSurfaceEXT.restype = VkResult
    vkCreateMetalSurfaceEXT.argtypes = [VkInstance, ctypes.POINTER(VkMetalSurfaceCreateInfoEXT), ctypes.POINTER(VkAllocationCallbacks), ctypes.POINTER(VkSurfaceKHR)]
vkCmdSetViewportWScalingNV = VK_DLL.vkCmdSetViewportWScalingNV
vkCmdSetViewportWScalingNV.restype = None
vkCmdSetViewportWScalingNV.argtypes = [VkCommandBuffer, ctypes.c_uint32, ctypes.c_uint32, ctypes.POINTER(VkViewportWScalingNV)]
vkCmdSetDiscardRectangleEXT = VK_DLL.vkCmdSetDiscardRectangleEXT
vkCmdSetDiscardRectangleEXT.restype = None
vkCmdSetDiscardRectangleEXT.argtypes = [VkCommandBuffer, ctypes.c_uint32, ctypes.c_uint32, ctypes.POINTER(VkRect2D)]
vkCmdSetSampleLocationsEXT = VK_DLL.vkCmdSetSampleLocationsEXT
vkCmdSetSampleLocationsEXT.restype = None
vkCmdSetSampleLocationsEXT.argtypes = [VkCommandBuffer, ctypes.POINTER(VkSampleLocationsInfoEXT)]
vkGetPhysicalDeviceMultisamplePropertiesEXT = VK_DLL.vkGetPhysicalDeviceMultisamplePropertiesEXT
vkGetPhysicalDeviceMultisamplePropertiesEXT.restype = None
vkGetPhysicalDeviceMultisamplePropertiesEXT.argtypes = [VkPhysicalDevice, VkSampleCountFlagBits, ctypes.POINTER(VkMultisamplePropertiesEXT)]
vkGetPhysicalDeviceSurfaceCapabilities2KHR = VK_DLL.vkGetPhysicalDeviceSurfaceCapabilities2KHR
vkGetPhysicalDeviceSurfaceCapabilities2KHR.restype = VkResult
vkGetPhysicalDeviceSurfaceCapabilities2KHR.argtypes = [VkPhysicalDevice, ctypes.POINTER(VkPhysicalDeviceSurfaceInfo2KHR), ctypes.POINTER(VkSurfaceCapabilities2KHR)]
vkGetPhysicalDeviceSurfaceFormats2KHR = VK_DLL.vkGetPhysicalDeviceSurfaceFormats2KHR
vkGetPhysicalDeviceSurfaceFormats2KHR.restype = VkResult
vkGetPhysicalDeviceSurfaceFormats2KHR.argtypes = [VkPhysicalDevice, ctypes.POINTER(VkPhysicalDeviceSurfaceInfo2KHR), ctypes.POINTER(ctypes.c_uint32), ctypes.POINTER(VkSurfaceFormat2KHR)]
vkGetPhysicalDeviceDisplayProperties2KHR = VK_DLL.vkGetPhysicalDeviceDisplayProperties2KHR
vkGetPhysicalDeviceDisplayProperties2KHR.restype = VkResult
vkGetPhysicalDeviceDisplayProperties2KHR.argtypes = [VkPhysicalDevice, ctypes.POINTER(ctypes.c_uint32), ctypes.POINTER(VkDisplayProperties2KHR)]
vkGetPhysicalDeviceDisplayPlaneProperties2KHR = VK_DLL.vkGetPhysicalDeviceDisplayPlaneProperties2KHR
vkGetPhysicalDeviceDisplayPlaneProperties2KHR.restype = VkResult
vkGetPhysicalDeviceDisplayPlaneProperties2KHR.argtypes = [VkPhysicalDevice, ctypes.POINTER(ctypes.c_uint32), ctypes.POINTER(VkDisplayPlaneProperties2KHR)]
vkGetDisplayModeProperties2KHR = VK_DLL.vkGetDisplayModeProperties2KHR
vkGetDisplayModeProperties2KHR.restype = VkResult
vkGetDisplayModeProperties2KHR.argtypes = [VkPhysicalDevice, VkDisplayKHR, ctypes.POINTER(ctypes.c_uint32), ctypes.POINTER(VkDisplayModeProperties2KHR)]
vkGetDisplayPlaneCapabilities2KHR = VK_DLL.vkGetDisplayPlaneCapabilities2KHR
vkGetDisplayPlaneCapabilities2KHR.restype = VkResult
vkGetDisplayPlaneCapabilities2KHR.argtypes = [VkPhysicalDevice, ctypes.POINTER(VkDisplayPlaneInfo2KHR), ctypes.POINTER(VkDisplayPlaneCapabilities2KHR)]
...
vkCreateValidationCacheEXT = VK_DLL.vkCreateValidationCacheEXT
vkCreateValidationCacheEXT.restype = VkResult
vkCreateValidationCacheEXT.argtypes = [VkDevice, ctypes.POINTER(VkValidationCacheCreateInfoEXT), ctypes.POINTER(VkAllocationCallbacks), ctypes.POINTER(VkValidationCacheEXT)]
vkDestroyValidationCacheEXT = VK_DLL.vkDestroyValidationCacheEXT
vkDestroyValidationCacheEXT.restype = None
vkDestroyValidationCacheEXT.argtypes = [VkDevice, VkValidationCacheEXT, ctypes.POINTER(VkAllocationCallbacks)]
vkGetValidationCacheDataEXT = VK_DLL.vkGetValidationCacheDataEXT
vkGetValidationCacheDataEXT.restype = VkResult
vkGetValidationCacheDataEXT.argtypes = [VkDevice, VkValidationCacheEXT, ctypes.POINTER(ctypes.c_size_t), ctypes.c_void_p]
vkMergeValidationCachesEXT = VK_DLL.vkMergeValidationCachesEXT
vkMergeValidationCachesEXT.restype = VkResult
vkMergeValidationCachesEXT.argtypes = [VkDevice, VkValidationCacheEXT, ctypes.c_uint32, ctypes.POINTER(VkValidationCacheEXT)]
...
if VK_USE_PLATFORM_ANDROID_KHR:
    vkGetSwapchainGrallocUsageANDROID = VK_DLL.vkGetSwapchainGrallocUsageANDROID
    vkGetSwapchainGrallocUsageANDROID.restype = VkResult
    vkGetSwapchainGrallocUsageANDROID.argtypes = [VkDevice, VkFormat, VkImageUsageFlags, ctypes.POINTER(ctypes.c_int)]
if VK_USE_PLATFORM_ANDROID_KHR:
    vkGetSwapchainGrallocUsage2ANDROID = VK_DLL.vkGetSwapchainGrallocUsage2ANDROID
    vkGetSwapchainGrallocUsage2ANDROID.restype = VkResult
    vkGetSwapchainGrallocUsage2ANDROID.argtypes = [VkDevice, VkFormat, VkImageUsageFlags, VkSwapchainImageUsageFlagsANDROID, ctypes.POINTER(ctypes.c_uint64), ctypes.POINTER(ctypes.c_uint64)]
if VK_USE_PLATFORM_ANDROID_KHR:
    vkAcquireImageANDROID = VK_DLL.vkAcquireImageANDROID
    vkAcquireImageANDROID.restype = VkResult
    vkAcquireImageANDROID.argtypes = [VkDevice, VkImage, ctypes.c_int, VkSemaphore, VkFence]
if VK_USE_PLATFORM_ANDROID_KHR:
    vkQueueSignalReleaseImageANDROID = VK_DLL.vkQueueSignalReleaseImageANDROID
    vkQueueSignalReleaseImageANDROID.restype = VkResult
    vkQueueSignalReleaseImageANDROID.argtypes = [VkQueue, ctypes.c_uint32, ctypes.POINTER(VkSemaphore), VkImage, ctypes.POINTER(ctypes.c_int)]
vkGetShaderInfoAMD = VK_DLL.vkGetShaderInfoAMD
vkGetShaderInfoAMD.restype = VkResult
vkGetShaderInfoAMD.argtypes = [VkDevice, VkPipeline, VkShaderStageFlagBits, VkShaderInfoTypeAMD, ctypes.POINTER(ctypes.c_size_t), ctypes.c_void_p]
vkSetLocalDimmingAMD = VK_DLL.vkSetLocalDimmingAMD
vkSetLocalDimmingAMD.restype = None
vkSetLocalDimmingAMD.argtypes = [VkDevice, VkSwapchainKHR, VkBool32]
vkGetPhysicalDeviceCalibrateableTimeDomainsEXT = VK_DLL.vkGetPhysicalDeviceCalibrateableTimeDomainsEXT
vkGetPhysicalDeviceCalibrateableTimeDomainsEXT.restype = VkResult
vkGetPhysicalDeviceCalibrateableTimeDomainsEXT.argtypes = [VkPhysicalDevice, ctypes.POINTER(ctypes.c_uint32), ctypes.POINTER(VkTimeDomainEXT)]
vkGetCalibratedTimestampsEXT = VK_DLL.vkGetCalibratedTimestampsEXT
vkGetCalibratedTimestampsEXT.restype = VkResult
vkGetCalibratedTimestampsEXT.argtypes = [VkDevice, ctypes.c_uint32, ctypes.POINTER(VkCalibratedTimestampInfoEXT), ctypes.POINTER(ctypes.c_uint64), ctypes.POINTER(ctypes.c_uint64)]
vkSetDebugUtilsObjectNameEXT = VK_DLL.vkSetDebugUtilsObjectNameEXT
vkSetDebugUtilsObjectNameEXT.restype = VkResult
vkSetDebugUtilsObjectNameEXT.argtypes = [VkDevice, ctypes.POINTER(VkDebugUtilsObjectNameInfoEXT)]
vkSetDebugUtilsObjectTagEXT = VK_DLL.vkSetDebugUtilsObjectTagEXT
vkSetDebugUtilsObjectTagEXT.restype = VkResult
vkSetDebugUtilsObjectTagEXT.argtypes = [VkDevice, ctypes.POINTER(VkDebugUtilsObjectTagInfoEXT)]
vkQueueBeginDebugUtilsLabelEXT = VK_DLL.vkQueueBeginDebugUtilsLabelEXT
vkQueueBeginDebugUtilsLabelEXT.restype = None
vkQueueBeginDebugUtilsLabelEXT.argtypes = [VkQueue, ctypes.POINTER(VkDebugUtilsLabelEXT)]
vkQueueEndDebugUtilsLabelEXT = VK_DLL.vkQueueEndDebugUtilsLabelEXT
vkQueueEndDebugUtilsLabelEXT.restype = None
vkQueueEndDebugUtilsLabelEXT.argtypes = [VkQueue]
vkQueueInsertDebugUtilsLabelEXT = VK_DLL.vkQueueInsertDebugUtilsLabelEXT
vkQueueInsertDebugUtilsLabelEXT.restype = None
vkQueueInsertDebugUtilsLabelEXT.argtypes = [VkQueue, ctypes.POINTER(VkDebugUtilsLabelEXT)]
vkCmdBeginDebugUtilsLabelEXT = VK_DLL.vkCmdBeginDebugUtilsLabelEXT
vkCmdBeginDebugUtilsLabelEXT.restype = None
vkCmdBeginDebugUtilsLabelEXT.argtypes = [VkCommandBuffer, ctypes.POINTER(VkDebugUtilsLabelEXT)]
vkCmdEndDebugUtilsLabelEXT = VK_DLL.vkCmdEndDebugUtilsLabelEXT
vkCmdEndDebugUtilsLabelEXT.restype = None
vkCmdEndDebugUtilsLabelEXT.argtypes = [VkCommandBuffer]
vkCmdInsertDebugUtilsLabelEXT = VK_DLL.vkCmdInsertDebugUtilsLabelEXT
vkCmdInsertDebugUtilsLabelEXT.restype = None
vkCmdInsertDebugUtilsLabelEXT.argtypes = [VkCommandBuffer, ctypes.POINTER(VkDebugUtilsLabelEXT)]
vkCreateDebugUtilsMessengerEXT = VK_DLL.vkCreateDebugUtilsMessengerEXT
vkCreateDebugUtilsMessengerEXT.restype = VkResult
vkCreateDebugUtilsMessengerEXT.argtypes = [VkInstance, ctypes.POINTER(VkDebugUtilsMessengerCreateInfoEXT), ctypes.POINTER(VkAllocationCallbacks), ctypes.POINTER(VkDebugUtilsMessengerEXT)]
vkDestroyDebugUtilsMessengerEXT = VK_DLL.vkDestroyDebugUtilsMessengerEXT
vkDestroyDebugUtilsMessengerEXT.restype = None
vkDestroyDebugUtilsMessengerEXT.argtypes = [VkInstance, VkDebugUtilsMessengerEXT, ctypes.POINTER(VkAllocationCallbacks)]
vkSubmitDebugUtilsMessageEXT = VK_DLL.vkSubmitDebugUtilsMessageEXT
vkSubmitDebugUtilsMessageEXT.restype = None
vkSubmitDebugUtilsMessageEXT.argtypes = [VkInstance, VkDebugUtilsMessageSeverityFlagBitsEXT, VkDebugUtilsMessageTypeFlagsEXT, ctypes.POINTER(VkDebugUtilsMessengerCallbackDataEXT)]
vkGetMemoryHostPointerPropertiesEXT = VK_DLL.vkGetMemoryHostPointerPropertiesEXT
vkGetMemoryHostPointerPropertiesEXT.restype = VkResult
vkGetMemoryHostPointerPropertiesEXT.argtypes = [VkDevice, VkExternalMemoryHandleTypeFlagBits, ctypes.c_void_p, ctypes.POINTER(VkMemoryHostPointerPropertiesEXT)]
vkCmdWriteBufferMarkerAMD = VK_DLL.vkCmdWriteBufferMarkerAMD
vkCmdWriteBufferMarkerAMD.restype = None
vkCmdWriteBufferMarkerAMD.argtypes = [VkCommandBuffer, VkPipelineStageFlagBits, VkBuffer, VkDeviceSize, ctypes.c_uint32]
...
if VK_USE_PLATFORM_ANDROID_KHR:
    vkGetAndroidHardwareBufferPropertiesANDROID = VK_DLL.vkGetAndroidHardwareBufferPropertiesANDROID
    vkGetAndroidHardwareBufferPropertiesANDROID.restype = VkResult
    vkGetAndroidHardwareBufferPropertiesANDROID.argtypes = [VkDevice, ctypes.POINTER(AHardwareBuffer), ctypes.POINTER(VkAndroidHardwareBufferPropertiesANDROID)]
if VK_USE_PLATFORM_ANDROID_KHR:
    vkGetMemoryAndroidHardwareBufferANDROID = VK_DLL.vkGetMemoryAndroidHardwareBufferANDROID
    vkGetMemoryAndroidHardwareBufferANDROID.restype = VkResult
    vkGetMemoryAndroidHardwareBufferANDROID.argtypes = [VkDevice, ctypes.POINTER(VkMemoryGetAndroidHardwareBufferInfoANDROID), ctypes.POINTER(ctypes.POINTER(AHardwareBuffer))]
...
vkCmdSetCheckpointNV = VK_DLL.vkCmdSetCheckpointNV
vkCmdSetCheckpointNV.restype = None
vkCmdSetCheckpointNV.argtypes = [VkCommandBuffer, ctypes.c_void_p]
vkGetQueueCheckpointDataNV = VK_DLL.vkGetQueueCheckpointDataNV
vkGetQueueCheckpointDataNV.restype = None
vkGetQueueCheckpointDataNV.argtypes = [VkQueue, ctypes.POINTER(ctypes.c_uint32), ctypes.POINTER(VkCheckpointDataNV)]
vkCmdBindTransformFeedbackBuffersEXT = VK_DLL.vkCmdBindTransformFeedbackBuffersEXT
vkCmdBindTransformFeedbackBuffersEXT.restype = None
vkCmdBindTransformFeedbackBuffersEXT.argtypes = [VkCommandBuffer, ctypes.c_uint32, ctypes.c_uint32, ctypes.POINTER(VkBuffer), ctypes.POINTER(VkDeviceSize), ctypes.POINTER(VkDeviceSize)]
vkCmdBeginTransformFeedbackEXT = VK_DLL.vkCmdBeginTransformFeedbackEXT
vkCmdBeginTransformFeedbackEXT.restype = None
vkCmdBeginTransformFeedbackEXT.argtypes = [VkCommandBuffer, ctypes.c_uint32, ctypes.c_uint32, ctypes.POINTER(VkBuffer), ctypes.POINTER(VkDeviceSize)]
vkCmdEndTransformFeedbackEXT = VK_DLL.vkCmdEndTransformFeedbackEXT
vkCmdEndTransformFeedbackEXT.restype = None
vkCmdEndTransformFeedbackEXT.argtypes = [VkCommandBuffer, ctypes.c_uint32, ctypes.c_uint32, ctypes.POINTER(VkBuffer), ctypes.POINTER(VkDeviceSize)]
vkCmdBeginQueryIndexedEXT = VK_DLL.vkCmdBeginQueryIndexedEXT
vkCmdBeginQueryIndexedEXT.restype = None
vkCmdBeginQueryIndexedEXT.argtypes = [VkCommandBuffer, VkQueryPool, ctypes.c_uint32, VkQueryControlFlags, ctypes.c_uint32]
vkCmdEndQueryIndexedEXT = VK_DLL.vkCmdEndQueryIndexedEXT
vkCmdEndQueryIndexedEXT.restype = None
vkCmdEndQueryIndexedEXT.argtypes = [VkCommandBuffer, VkQueryPool, ctypes.c_uint32, ctypes.c_uint32]
vkCmdDrawIndirectByteCountEXT = VK_DLL.vkCmdDrawIndirectByteCountEXT
vkCmdDrawIndirectByteCountEXT.restype = None
vkCmdDrawIndirectByteCountEXT.argtypes = [VkCommandBuffer, ctypes.c_uint32, ctypes.c_uint32, VkBuffer, VkDeviceSize, ctypes.c_uint32, ctypes.c_uint32]
vkCmdSetExclusiveScissorNV = VK_DLL.vkCmdSetExclusiveScissorNV
vkCmdSetExclusiveScissorNV.restype = None
vkCmdSetExclusiveScissorNV.argtypes = [VkCommandBuffer, ctypes.c_uint32, ctypes.c_uint32, ctypes.POINTER(VkRect2D)]
vkCmdBindShadingRateImageNV = VK_DLL.vkCmdBindShadingRateImageNV
vkCmdBindShadingRateImageNV.restype = None
vkCmdBindShadingRateImageNV.argtypes = [VkCommandBuffer, VkImageView, VkImageLayout]
vkCmdSetViewportShadingRatePaletteNV = VK_DLL.vkCmdSetViewportShadingRatePaletteNV
vkCmdSetViewportShadingRatePaletteNV.restype = None
vkCmdSetViewportShadingRatePaletteNV.argtypes = [VkCommandBuffer, ctypes.c_uint32, ctypes.c_uint32, ctypes.POINTER(VkShadingRatePaletteNV)]
vkCmdSetCoarseSampleOrderNV = VK_DLL.vkCmdSetCoarseSampleOrderNV
vkCmdSetCoarseSampleOrderNV.restype = None
vkCmdSetCoarseSampleOrderNV.argtypes = [VkCommandBuffer, VkCoarseSampleOrderTypeNV, ctypes.c_uint32, ctypes.POINTER(VkCoarseSampleOrderCustomNV)]
vkCmdDrawMeshTasksNV = VK_DLL.vkCmdDrawMeshTasksNV
vkCmdDrawMeshTasksNV.restype = None
vkCmdDrawMeshTasksNV.argtypes = [VkCommandBuffer, ctypes.c_uint32, ctypes.c_uint32]
vkCmdDrawMeshTasksIndirectNV = VK_DLL.vkCmdDrawMeshTasksIndirectNV
vkCmdDrawMeshTasksIndirectNV.restype = None
vkCmdDrawMeshTasksIndirectNV.argtypes = [VkCommandBuffer, VkBuffer, VkDeviceSize, ctypes.c_uint32, ctypes.c_uint32]
vkCmdDrawMeshTasksIndirectCountNV = VK_DLL.vkCmdDrawMeshTasksIndirectCountNV
vkCmdDrawMeshTasksIndirectCountNV.restype = None
vkCmdDrawMeshTasksIndirectCountNV.argtypes = [VkCommandBuffer, VkBuffer, VkDeviceSize, VkBuffer, VkDeviceSize, ctypes.c_uint32, ctypes.c_uint32]
vkCompileDeferredNV = VK_DLL.vkCompileDeferredNV
vkCompileDeferredNV.restype = VkResult
vkCompileDeferredNV.argtypes = [VkDevice, VkPipeline, ctypes.c_uint32]
vkCreateAccelerationStructureNV = VK_DLL.vkCreateAccelerationStructureNV
vkCreateAccelerationStructureNV.restype = VkResult
vkCreateAccelerationStructureNV.argtypes = [VkDevice, ctypes.POINTER(VkAccelerationStructureCreateInfoNV), ctypes.POINTER(VkAllocationCallbacks), ctypes.POINTER(VkAccelerationStructureNV)]
vkDestroyAccelerationStructureKHR = VK_DLL.vkDestroyAccelerationStructureKHR
vkDestroyAccelerationStructureKHR.restype = None
vkDestroyAccelerationStructureKHR.argtypes = [VkDevice, VkAccelerationStructureKHR, ctypes.POINTER(VkAllocationCallbacks)]
vkDestroyAccelerationStructureNV = VK_DLL.vkDestroyAccelerationStructureNV
vkDestroyAccelerationStructureNV.restype = None
vkDestroyAccelerationStructureNV.argtypes = [VkDevice, VkAccelerationStructureNV, ctypes.POINTER(VkAllocationCallbacks)]
vkGetAccelerationStructureMemoryRequirementsNV = VK_DLL.vkGetAccelerationStructureMemoryRequirementsNV
vkGetAccelerationStructureMemoryRequirementsNV.restype = None
vkGetAccelerationStructureMemoryRequirementsNV.argtypes = [VkDevice, ctypes.POINTER(VkAccelerationStructureMemoryRequirementsInfoNV), ctypes.POINTER(VkMemoryRequirements2KHR)]
vkBindAccelerationStructureMemoryNV = VK_DLL.vkBindAccelerationStructureMemoryNV
vkBindAccelerationStructureMemoryNV.restype = VkResult
vkBindAccelerationStructureMemoryNV.argtypes = [VkDevice, ctypes.c_uint32, ctypes.POINTER(VkBindAccelerationStructureMemoryInfoNV)]
vkCmdCopyAccelerationStructureNV = VK_DLL.vkCmdCopyAccelerationStructureNV
...
vkCmdCopyAccelerationStructureKHR = VK_DLL.vkCmdCopyAccelerationStructureKHR
vkCmdCopyAccelerationStructureKHR.restype = None
vkCmdCopyAccelerationStructureKHR.argtypes = [VkCommandBuffer, ctypes.POINTER(VkCopyAccelerationStructureInfoKHR)]
vkCopyAccelerationStructureKHR = VK_DLL.vkCopyAccelerationStructureKHR
vkCopyAccelerationStructureKHR.restype = VkResult
vkCopyAccelerationStructureKHR.argtypes = [VkDevice, VkDeferredOperationKHR, ctypes.POINTER(VkCopyAccelerationStructureInfoKHR)]
vkCmdCopyAccelerationStructureToMemoryKHR = VK_DLL.vkCmdCopyAccelerationStructureToMemoryKHR
vkCmdCopyAccelerationStructureToMemoryKHR.restype = None
vkCmdCopyAccelerationStructureToMemoryKHR.argtypes = [VkCommandBuffer, ctypes.POINTER(VkCopyAccelerationStructureToMemoryInfoKHR)]
vkCopyAccelerationStructureToMemoryKHR = VK_DLL.vkCopyAccelerationStructureToMemoryKHR
vkCopyAccelerationStructureToMemoryKHR.restype = VkResult
vkCopyAccelerationStructureToMemoryKHR.argtypes = [VkDevice, VkDeferredOperationKHR, ctypes.POINTER(VkCopyAccelerationStructureToMemoryInfoKHR)]
vkCmdCopyMemoryToAccelerationStructureKHR = VK_DLL.vkCmdCopyMemoryToAccelerationStructureKHR
vkCmdCopyMemoryToAccelerationStructureKHR.restype = None
vkCmdCopyMemoryToAccelerationStructureKHR.argtypes = [VkCommandBuffer, ctypes.POINTER(VkCopyMemoryToAccelerationStructureInfoKHR)]
vkCopyMemoryToAccelerationStructureKHR = VK_DLL.vkCopyMemoryToAccelerationStructureKHR
vkCopyMemoryToAccelerationStructureKHR.restype = VkResult
vkCopyMemoryToAccelerationStructureKHR.argtypes = [VkDevice, VkDeferredOperationKHR, ctypes.POINTER(VkCopyMemoryToAccelerationStructureInfoKHR)]
vkCmdWriteAccelerationStructuresPropertiesKHR = VK_DLL.vkCmdWriteAccelerationStructuresPropertiesKHR
vkCmdWriteAccelerationStructuresPropertiesKHR.restype = None
vkCmdWriteAccelerationStructuresPropertiesKHR.argtypes = [VkCommandBuffer, ctypes.c_uint32, ctypes.POINTER(VkAccelerationStructureKHR), VkQueryType, VkQueryPool, ctypes.c_uint32]
vkCmdWriteAccelerationStructuresPropertiesNV = VK_DLL.vkCmdWriteAccelerationStructuresPropertiesNV
vkCmdWriteAccelerationStructuresPropertiesNV.restype = None
vkCmdWriteAccelerationStructuresPropertiesNV.argtypes = [VkCommandBuffer, ctypes.c_uint32, ctypes.POINTER(VkAccelerationStructureNV), VkQueryType, VkQueryPool, ctypes.c_uint32]
vkCmdBuildAccelerationStructureNV = VK_DLL.vkCmdBuildAccelerationStructureNV
vkCmdBuildAccelerationStructureNV.restype = None
vkCmdBuildAccelerationStructureNV.argtypes = [VkCommandBuffer, ctypes.POINTER(VkAccelerationStructureInfoNV), VkBuffer, VkDeviceSize, VkBool32, VkAccelerationStructureNV, VkAccelerationStructureNV, VkBuffer, VkDeviceSize]
vkWriteAccelerationStructuresPropertiesKHR = VK_DLL.vkWriteAccelerationStructuresPropertiesKHR
vkWriteAccelerationStructuresPropertiesKHR.restype = VkResult
vkWriteAccelerationStructuresPropertiesKHR.argtypes = [VkDevice, ctypes.c_uint32, ctypes.POINTER(VkAccelerationStructureKHR), VkQueryType, ctypes.c_size_t, ctypes.c_void_p, ctypes.c_size_t]
vkCmdTraceRaysKHR = VK_DLL.vkCmdTraceRaysKHR
vkCmdTraceRaysKHR.restype = None
vkCmdTraceRaysKHR.argtypes = [VkCommandBuffer, ctypes.POINTER(VkStridedDeviceAddressRegionKHR), ctypes.POINTER(VkStridedDeviceAddressRegionKHR), ctypes.POINTER(VkStridedDeviceAddressRegionKHR), ctypes.POINTER(VkStridedDeviceAddressRegionKHR), ctypes.c_uint32, ctypes.c_uint32, ctypes.c_uint32]
vkCmdTraceRaysNV = VK_DLL.vkCmdTraceRaysNV
vkCmdTraceRaysNV.restype = None
vkCmdTraceRaysNV.argtypes = [VkCommandBuffer, VkBuffer, VkDeviceSize, VkBuffer, VkDeviceSize, VkDeviceSize, VkBuffer, VkDeviceSize, VkDeviceSize, VkBuffer, VkDeviceSize, VkDeviceSize, ctypes.c_uint32, ctypes.c_uint32, ctypes.c_uint32]
vkGetRayTracingShaderGroupHandlesKHR = VK_DLL.vkGetRayTracingShaderGroupHandlesKHR
vkGetRayTracingShaderGroupHandlesKHR.restype = VkResult
vkGetRayTracingShaderGroupHandlesKHR.argtypes = [VkDevice, VkPipeline, ctypes.c_uint32, ctypes.c_uint32, ctypes.c_size_t, ctypes.c_void_p]
vkGetRayTracingShaderGroupHandlesNV = vkGetRayTracingShaderGroupHandlesKHR
vkGetRayTracingCaptureReplayShaderGroupHandlesKHR = VK_DLL.vkGetRayTracingCaptureReplayShaderGroupHandlesKHR
vkGetRayTracingCaptureReplayShaderGroupHandlesKHR.restype = VkResult
vkGetRayTracingCaptureReplayShaderGroupHandlesKHR.argtypes = [VkDevice, VkPipeline, ctypes.c_uint32, ctypes.c_uint32, ctypes.c_size_t, ctypes.c_void_p]
vkGetAccelerationStructureHandleNV = VK_DLL.vkGetAccelerationStructureHandleNV
vkGetAccelerationStructureHandleNV.restype = VkResult
vkGetAccelerationStructureHandleNV.argtypes = [VkDevice, VkAccelerationStructureNV, ctypes.c_size_t, ctypes.c_void_p]
vkCreateRayTracingPipelinesNV = VK_DLL.vkCreateRayTracingPipelinesNV
vkCreateRayTracingPipelinesNV.restype = VkResult
vkCreateRayTracingPipelinesNV.argtypes = [VkDevice, VkPipelineCache, ctypes.c_uint32, ctypes.POINTER(VkRayTracingPipelineCreateInfoNV), ctypes.POINTER(VkAllocationCallbacks), ctypes.POINTER(VkPipeline)]
vkCreateRayTracingPipelinesKHR = VK_DLL.vkCreateRayTracingPipelinesKHR
vkCreateRayTracingPipelinesKHR.restype = VkResult
vkCreateRayTracingPipelinesKHR.argtypes = [VkDevice, VkDeferredOperationKHR, VkPipelineCache, ctypes.c_uint32, ctypes.POINTER(VkRayTracingPipelineCreateInfoKHR), ctypes.POINTER(VkAllocationCallbacks), ctypes.POINTER(VkPipeline)]
vkGetPhysicalDeviceCooperativeMatrixPropertiesNV = VK_DLL.vkGetPhysicalDeviceCooperativeMatrixPropertiesNV
vkGetPhysicalDeviceCooperativeMatrixPropertiesNV.restype = VkResult
vkGetPhysicalDeviceCooperativeMatrixPropertiesNV.argtypes = [VkPhysicalDevice, ctypes.POINTER(ctypes.c_uint32), ctypes.POINTER(VkCooperativeMatrixPropertiesNV)]
vkCmdTraceRaysIndirectKHR = VK_DLL.vkCmdTraceRaysIndirectKHR
vkCmdTraceRaysIndirectKHR.restype = None
vkCmdTraceRaysIndirectKHR.argtypes = [VkCommandBuffer, ctypes.POINTER(VkStridedDeviceAddressRegionKHR), ctypes.POINTER(VkStridedDeviceAddressRegionKHR), ctypes.POINTER(VkStridedDeviceAddressRegionKHR), ctypes.POINTER(VkStridedDeviceAddressRegionKHR), VkDeviceAddress]
vkGetDeviceAccelerationStructureCompatibilityKHR = VK_DLL.vkGetDeviceAccelerationStructureCompatibilityKHR
vkGetDeviceAccelerationStructureCompatibilityKHR.restype = None
vkGetDeviceAccelerationStructureCompatibilityKHR.argtypes = [VkDevice, ctypes.POINTER(VkAccelerationStructureVersionInfoKHR), ctypes.POINTER(VkAccelerationStructureCompatibilityKHR)]
vkGetRayTracingShaderGroupStackSizeKHR = VK_DLL.vkGetRayTracingShaderGroupStackSizeKHR
vkGetRayTracingShaderGroupStackSizeKHR.restype = VkDeviceSize
vkGetRayTracingShaderGroupStackSizeKHR.argtypes = [VkDevice, VkPipeline, ctypes.c_uint32, VkShaderGroupShaderKHR]
vkCmdSetRayTracingPipelineStackSizeKHR = VK_DLL.vkCmdSetRayTracingPipelineStackSizeKHR
vkCmdSetRayTracingPipelineStackSizeKHR.restype = None
vkCmdSetRayTracingPipelineStackSizeKHR.argtypes = [VkCommandBuffer, ctypes.c_uint32]
vkGetImageViewHandleNVX = VK_DLL.vkGetImageViewHandleNVX
vkGetImageViewHandleNVX.restype = ctypes.c_uint32
vkGetImageViewHandleNVX.argtypes = [VkDevice, ctypes.POINTER(VkImageViewHandleInfoNVX)]
vkGetImageViewAddressNVX = VK_DLL.vkGetImageViewAddressNVX
vkGetImageViewAddressNVX.restype = VkResult
vkGetImageViewAddressNVX.argtypes = [VkDevice, VkImageView, ctypes.POINTER(VkImageViewAddressPropertiesNVX)]
if VK_USE_PLATFORM_WIN32_KHR:
    vkGetPhysicalDeviceSurfacePresentModes2EXT = VK_DLL.vkGetPhysicalDeviceSurfacePresentModes2EXT
    vkGetPhysicalDeviceSurfacePresentModes2EXT.restype = VkResult
    vkGetPhysicalDeviceSurfacePresentModes2EXT.argtypes = [VkPhysicalDevice, ctypes.POINTER(VkPhysicalDeviceSurfaceInfo2KHR), ctypes.POINTER(ctypes.c_uint32), ctypes.POINTER(VkPresentModeKHR)]
if VK_USE_PLATFORM_WIN32_KHR:
    vkGetDeviceGroupSurfacePresentModes2EXT = VK_DLL.vkGetDeviceGroupSurfacePresentModes2EXT
    vkGetDeviceGroupSurfacePresentModes2EXT.restype = VkResult
    vkGetDeviceGroupSurfacePresentModes2EXT.argtypes = [VkDevice, ctypes.POINTER(VkPhysicalDeviceSurfaceInfo2KHR), ctypes.POINTER(VkDeviceGroupPresentModeFlagsKHR)]
if VK_USE_PLATFORM_WIN32_KHR:
    vkAcquireFullScreenExclusiveModeEXT = VK_DLL.vkAcquireFullScreenExclusiveModeEXT
    vkAcquireFullScreenExclusiveModeEXT.restype = VkResult
    vkAcquireFullScreenExclusiveModeEXT.argtypes = [VkDevice, VkSwapchainKHR]
if VK_USE_PLATFORM_WIN32_KHR:
    vkReleaseFullScreenExclusiveModeEXT = VK_DLL.vkReleaseFullScreenExclusiveModeEXT
    vkReleaseFullScreenExclusiveModeEXT.restype = VkResult
    vkReleaseFullScreenExclusiveModeEXT.argtypes = [VkDevice, VkSwapchainKHR]
vkEnumeratePhysicalDeviceQueueFamilyPerformanceQueryCountersKHR = VK_DLL.vkEnumeratePhysicalDeviceQueueFamilyPerformanceQueryCountersKHR
vkEnumeratePhysicalDeviceQueueFamilyPerformanceQueryCountersKHR.restype = VkResult
vkEnumeratePhysicalDeviceQueueFamilyPerformanceQueryCountersKHR.argtypes = [VkPhysicalDevice, ctypes.c_uint32, ctypes.POINTER(ctypes.c_uint32), ctypes.POINTER(VkPerformanceCounterKHR), ctypes.POINTER(VkPerformanceCounterDescriptionKHR)]
vkGetPhysicalDeviceQueueFamilyPerformanceQueryPassesKHR = VK_DLL.vkGetPhysicalDeviceQueueFamilyPerformanceQueryPassesKHR
vkGetPhysicalDeviceQueueFamilyPerformanceQueryPassesKHR.restype = None
vkGetPhysicalDeviceQueueFamilyPerformanceQueryPassesKHR.argtypes = [VkPhysicalDevice, ctypes.POINTER(VkQueryPoolPerformanceCreateInfoKHR), ctypes.POINTER(ctypes.c_uint32)]
vkAcquireProfilingLockKHR = VK_DLL.vkAcquireProfilingLockKHR
vkAcquireProfilingLockKHR.restype = VkResult
vkAcquireProfilingLockKHR.argtypes = [VkDevice, ctypes.POINTER(VkAcquireProfilingLockInfoKHR)]
vkReleaseProfilingLockKHR = VK_DLL.vkReleaseProfilingLockKHR
vkReleaseProfilingLockKHR.restype = None
vkReleaseProfilingLockKHR.argtypes = [VkDevice]
vkGetImageDrmFormatModifierPropertiesEXT = VK_DLL.vkGetImageDrmFormatModifierPropertiesEXT
vkGetImageDrmFormatModifierPropertiesEXT.restype = VkResult
vkGetImageDrmFormatModifierPropertiesEXT.argtypes = [VkDevice, VkImage, ctypes.POINTER(VkImageDrmFormatModifierPropertiesEXT)]
...
vkCreateHeadlessSurfaceEXT = VK_DLL.vkCreateHeadlessSurfaceEXT
vkCreateHeadlessSurfaceEXT.restype = VkResult
vkCreateHeadlessSurfaceEXT.argtypes = [VkInstance, ctypes.POINTER(VkHeadlessSurfaceCreateInfoEXT), ctypes.POINTER(VkAllocationCallbacks), ctypes.POINTER(VkSurfaceKHR)]
vkGetPhysicalDeviceSupportedFramebufferMixedSamplesCombinationsNV = VK_DLL.vkGetPhysicalDeviceSupportedFramebufferMixedSamplesCombinationsNV
vkGetPhysicalDeviceSupportedFramebufferMixedSamplesCombinationsNV.restype = VkResult
vkGetPhysicalDeviceSupportedFramebufferMixedSamplesCombinationsNV.argtypes = [VkPhysicalDevice, ctypes.POINTER(ctypes.c_uint32), ctypes.POINTER(VkFramebufferMixedSamplesCombinationNV)]
vkInitializePerformanceApiINTEL = VK_DLL.vkInitializePerformanceApiINTEL
vkInitializePerformanceApiINTEL.restype = VkResult
vkInitializePerformanceApiINTEL.argtypes = [VkDevice, ctypes.POINTER(VkInitializePerformanceApiInfoINTEL)]
vkUninitializePerformanceApiINTEL = VK_DLL.vkUninitializePerformanceApiINTEL
vkUninitializePerformanceApiINTEL.restype = None
vkUninitializePerformanceApiINTEL.argtypes = [VkDevice]
vkCmdSetPerformanceMarkerINTEL = VK_DLL.vkCmdSetPerformanceMarkerINTEL
vkCmdSetPerformanceMarkerINTEL.restype = VkResult
vkCmdSetPerformanceMarkerINTEL.argtypes = [VkCommandBuffer, ctypes.POINTER(VkPerformanceMarkerInfoINTEL)]
vkCmdSetPerformanceStreamMarkerINTEL = VK_DLL.vkCmdSetPerformanceStreamMarkerINTEL
vkCmdSetPerformanceStreamMarkerINTEL.restype = VkResult
vkCmdSetPerformanceStreamMarkerINTEL.argtypes = [VkCommandBuffer, ctypes.POINTER(VkPerformanceStreamMarkerInfoINTEL)]
vkCmdSetPerformanceOverrideINTEL = VK_DLL.vkCmdSetPerformanceOverrideINTEL
vkCmdSetPerformanceOverrideINTEL.restype = VkResult
vkCmdSetPerformanceOverrideINTEL.argtypes = [VkCommandBuffer, ctypes.POINTER(VkPerformanceOverrideInfoINTEL)]
vkAcquirePerformanceConfigurationINTEL = VK_DLL.vkAcquirePerformanceConfigurationINTEL
vkAcquirePerformanceConfigurationINTEL.restype = VkResult
vkAcquirePerformanceConfigurationINTEL.argtypes = [VkDevice, ctypes.POINTER(VkPerformanceConfigurationAcquireInfoINTEL), ctypes.POINTER(VkPerformanceConfigurationINTEL)]
vkReleasePerformanceConfigurationINTEL = VK_DLL.vkReleasePerformanceConfigurationINTEL
...
vkQueueSetPerformanceConfigurationINTEL = VK_DLL.vkQueueSetPerformanceConfigurationINTEL
...
vkGetPerformanceParameterINTEL = VK_DLL.vkGetPerformanceParameterINTEL
vkGetPerformanceParameterINTEL.restype = VkResult
vkGetPerformanceParameterINTEL.argtypes = [VkDevice, VkPerformanceParameterTypeINTEL, ctypes.POINTER(VkPerformanceValueINTEL)]
...
vkGetPipelineExecutablePropertiesKHR = VK_DLL.vkGetPipelineExecutablePropertiesKHR
vkGetPipelineExecutablePropertiesKHR.restype = VkResult
vkGetPipelineExecutablePropertiesKHR.argtypes = [VkDevice, ctypes.POINTER(VkPipelineInfoKHR), ctypes.POINTER(ctypes.c_uint32), ctypes.POINTER(VkPipelineExecutablePropertiesKHR)]
vkGetPipelineExecutableStatisticsKHR = VK_DLL.vkGetPipelineExecutableStatisticsKHR
vkGetPipelineExecutableStatisticsKHR.restype = VkResult
vkGetPipelineExecutableStatisticsKHR.argtypes = [VkDevice, ctypes.POINTER(VkPipelineExecutableInfoKHR), ctypes.POINTER(ctypes.c_uint32), ctypes.POINTER(VkPipelineExecutableStatisticKHR)]
vkGetPipelineExecutableInternalRepresentationsKHR = VK_DLL.vkGetPipelineExecutableInternalRepresentationsKHR
vkGetPipelineExecutableInternalRepresentationsKHR.restype = VkResult
vkGetPipelineExecutableInternalRepresentationsKHR.argtypes = [VkDevice, ctypes.POINTER(VkPipelineExecutableInfoKHR), ctypes.POINTER(ctypes.c_uint32), ctypes.POINTER(VkPipelineExecutableInternalRepresentationKHR)]
vkCmdSetLineStippleEXT = VK_DLL.vkCmdSetLineStippleEXT
vkCmdSetLineStippleEXT.restype = None
vkCmdSetLineStippleEXT.argtypes = [VkCommandBuffer, ctypes.c_uint32, ctypes.c_uint16]
vkGetPhysicalDeviceToolPropertiesEXT = VK_DLL.vkGetPhysicalDeviceToolPropertiesEXT
vkGetPhysicalDeviceToolPropertiesEXT.restype = VkResult
vkGetPhysicalDeviceToolPropertiesEXT.argtypes = [VkPhysicalDevice, ctypes.POINTER(ctypes.c_uint32), ctypes.POINTER(VkPhysicalDeviceToolPropertiesEXT)]
vkCreateAccelerationStructureKHR = VK_DLL.vkCreateAccelerationStructureKHR
vkCreateAccelerationStructureKHR.restype = VkResult
vkCreateAccelerationStructureKHR.argtypes = [VkDevice, ctypes.POINTER(VkAccelerationStructureCreateInfoKHR), ctypes.POINTER(VkAllocationCallbacks), ctypes.POINTER(VkAccelerationStructureKHR)]
vkCmdBuildAccelerationStructuresKHR = VK_DLL.vkCmdBuildAccelerationStructuresKHR
vkCmdBuildAccelerationStructuresKHR.restype = None
vkCmdBuildAccelerationStructuresKHR.argtypes = [VkCommandBuffer, ctypes.c_uint32, ctypes.POINTER(VkAccelerationStructureBuildGeometryInfoKHR), ctypes.POINTER(ctypes.POINTER(VkAccelerationStructureBuildRangeInfoKHR))]
vkCmdBuildAccelerationStructuresIndirectKHR = VK_DLL.vkCmdBuildAccelerationStructuresIndirectKHR
vkCmdBuildAccelerationStructuresIndirectKHR.restype = None
vkCmdBuildAccelerationStructuresIndirectKHR.argtypes = [VkCommandBuffer, ctypes.c_uint32, ctypes.POINTER(VkAccelerationStructureBuildGeometryInfoKHR), ctypes.POINTER(VkDeviceAddress), ctypes.POINTER(ctypes.c_uint32), ctypes.POINTER(ctypes.POINTER(ctypes.c_uint32))]
vkBuildAccelerationStructuresKHR = VK_DLL.vkBuildAccelerationStructuresKHR
vkBuildAccelerationStructuresKHR.restype = VkResult
vkBuildAccelerationStructuresKHR.argtypes = [VkDevice, VkDeferredOperationKHR, ctypes.c_uint32, ctypes.POINTER(VkAccelerationStructureBuildGeometryInfoKHR), ctypes.POINTER(ctypes.POINTER(VkAccelerationStructureBuildRangeInfoKHR))]
vkGetAccelerationStructureDeviceAddressKHR = VK_DLL.vkGetAccelerationStructureDeviceAddressKHR
vkGetAccelerationStructureDeviceAddressKHR.restype = VkDeviceAddress
vkGetAccelerationStructureDeviceAddressKHR.argtypes = [VkDevice, ctypes.POINTER(VkAccelerationStructureDeviceAddressInfoKHR)]
vkCreateDeferredOperationKHR = VK_DLL.vkCreateDeferredOperationKHR
vkCreateDeferredOperationKHR.restype = VkResult
vkCreateDeferredOperationKHR.argtypes = [VkDevice, ctypes.POINTER(VkAllocationCallbacks), ctypes.POINTER(VkDeferredOperationKHR)]
vkDestroyDeferredOperationKHR = VK_DLL.vkDestroyDeferredOperationKHR
vkDestroyDeferredOperationKHR.restype = None
vkDestroyDeferredOperationKHR.argtypes = [VkDevice, VkDeferredOperationKHR, ctypes.POINTER(VkAllocationCallbacks)]
vkGetDeferredOperationMaxConcurrencyKHR = VK_DLL.vkGetDeferredOperationMaxConcurrencyKHR
vkGetDeferredOperationMaxConcurrencyKHR.restype = ctypes.c_uint32
vkGetDeferredOperationMaxConcurrencyKHR.argtypes = [VkDevice, VkDeferredOperationKHR]
vkGetDeferredOperationResultKHR = VK_DLL.vkGetDeferredOperationResultKHR
vkGetDeferredOperationResultKHR.restype = VkResult
vkGetDeferredOperationResultKHR.argtypes = [VkDevice, VkDeferredOperationKHR]
vkDeferredOperationJoinKHR = VK_DLL.vkDeferredOperationJoinKHR
vkDeferredOperationJoinKHR.restype = VkResult
vkDeferredOperationJoinKHR.argtypes = [VkDevice, VkDeferredOperationKHR]
vkCmdSetCullModeEXT = VK_DLL.vkCmdSetCullModeEXT
vkCmdSetCullModeEXT.restype = None
vkCmdSetCullModeEXT.argtypes = [VkCommandBuffer, VkCullModeFlags]
vkCmdSetFrontFaceEXT = VK_DLL.vkCmdSetFrontFaceEXT
vkCmdSetFrontFaceEXT.restype = None
vkCmdSetFrontFaceEXT.argtypes = [VkCommandBuffer, VkFrontFace]
vkCmdSetPrimitiveTopologyEXT = VK_DLL.vkCmdSetPrimitiveTopologyEXT
vkCmdSetPrimitiveTopologyEXT.restype = None
vkCmdSetPrimitiveTopologyEXT.argtypes = [VkCommandBuffer, VkPrimitiveTopology]
vkCmdSetViewportWithCountEXT = VK_DLL.vkCmdSetViewportWithCountEXT
vkCmdSetViewportWithCountEXT.restype = None
vkCmdSetViewportWithCountEXT.argtypes = [VkCommandBuffer, ctypes.c_uint32, ctypes.POINTER(VkViewport)]
vkCmdSetScissorWithCountEXT = VK_DLL.vkCmdSetScissorWithCountEXT
vkCmdSetScissorWithCountEXT.restype = None
vkCmdSetScissorWithCountEXT.argtypes = [VkCommandBuffer, ctypes.c_uint32, ctypes.POINTER(VkRect2D)]
vkCmdBindVertexBuffers2EXT = VK_DLL.vkCmdBindVertexBuffers2EXT
vkCmdBindVertexBuffers2EXT.restype = None
vkCmdBindVertexBuffers2EXT.argtypes = [VkCommandBuffer, ctypes.c_uint32, ctypes.c_uint32, ctypes.POINTER(VkBuffer), ctypes.POINTER(VkDeviceSize), ctypes.POINTER(VkDeviceSize), ctypes.POINTER(VkDeviceSize)]
vkCmdSetDepthTestEnableEXT = VK_DLL.vkCmdSetDepthTestEnableEXT
vkCmdSetDepthTestEnableEXT.restype = None
vkCmdSetDepthTestEnableEXT.argtypes = [VkCommandBuffer, VkBool32]
vkCmdSetDepthWriteEnableEXT = VK_DLL.vkCmdSetDepthWriteEnableEXT
vkCmdSetDepthWriteEnableEXT.restype = None
vkCmdSetDepthWriteEnableEXT.argtypes = [VkCommandBuffer, VkBool32]
vkCmdSetDepthCompareOpEXT = VK_DLL.vkCmdSetDepthCompareOpEXT
vkCmdSetDepthCompareOpEXT.restype = None
vkCmdSetDepthCompareOpEXT.argtypes = [VkCommandBuffer, VkCompareOp]
vkCmdSetDepthBoundsTestEnableEXT = VK_DLL.vkCmdSetDepthBoundsTestEnableEXT
vkCmdSetDepthBoundsTestEnableEXT.restype = None
vkCmdSetDepthBoundsTestEnableEXT.argtypes = [VkCommandBuffer, VkBool32]
vkCmdSetStencilTestEnableEXT = VK_DLL.vkCmdSetStencilTestEnableEXT
vkCmdSetStencilTestEnableEXT.restype = None
vkCmdSetStencilTestEnableEXT.argtypes = [VkCommandBuffer, VkBool32]
vkCmdSetStencilOpEXT = VK_DLL.vkCmdSetStencilOpEXT
...
vkCreatePrivateDataSlotEXT = VK_DLL.vkCreatePrivateDataSlotEXT
vkCreatePrivateDataSlotEXT.restype = VkResult
vkCreatePrivateDataSlotEXT.argtypes = [VkDevice, ctypes.POINTER(VkPrivateDataSlotCreateInfoEXT), ctypes.POINTER(VkAllocationCallbacks), ctypes.POINTER(VkPrivateDataSlotEXT)]
vkDestroyPrivateDataSlotEXT = VK_DLL.vkDestroyPrivateDataSlotEXT
vkDestroyPrivateDataSlotEXT.restype = None
vkDestroyPrivateDataSlotEXT.argtypes = [VkDevice, VkPrivateDataSlotEXT, ctypes.POINTER(VkAllocationCallbacks)]
vkSetPrivateDataEXT = VK_DLL.vkSetPrivateDataEXT
vkSetPrivateDataEXT.restype = VkResult
vkSetPrivateDataEXT.argtypes = [VkDevice, VkObjectType, ctypes.c_uint64, VkPrivateDataSlotEXT, ctypes.c_uint64]
vkGetPrivateDataEXT = VK_DLL.vkGetPrivateDataEXT
vkGetPrivateDataEXT.restype = None
vkGetPrivateDataEXT.argtypes = [VkDevice, VkObjectType, ctypes.c_uint64, VkPrivateDataSlotEXT, ctypes.POINTER(ctypes.c_uint64)]
vkCmdCopyBuffer2KHR = VK_DLL.vkCmdCopyBuffer2KHR
vkCmdCopyBuffer2KHR.restype = None
vkCmdCopyBuffer2KHR.argtypes = [VkCommandBuffer, ctypes.POINTER(VkCopyBufferInfo2KHR)]
vkCmdCopyImage2KHR = VK_DLL.vkCmdCopyImage2KHR
vkCmdCopyImage2KHR.restype = None
vkCmdCopyImage2KHR.argtypes = [VkCommandBuffer, ctypes.POINTER(VkCopyImageInfo2KHR)]
vkCmdBlitImage2KHR = VK_DLL.vkCmdBlitImage2KHR
vkCmdBlitImage2KHR.restype = None
vkCmdBlitImage2KHR.argtypes = [VkCommandBuffer, ctypes.POINTER(VkBlitImageInfo2KHR)]
vkCmdCopyBufferToImage2KHR = VK_DLL.vkCmdCopyBufferToImage2KHR
vkCmdCopyBufferToImage2KHR.restype = None
vkCmdCopyBufferToImage2KHR.argtypes = [VkCommandBuffer, ctypes.POINTER(VkCopyBufferToImageInfo2KHR)]
vkCmdCopyImageToBuffer2KHR = VK_DLL.vkCmdCopyImageToBuffer2KHR
vkCmdCopyImageToBuffer2KHR.restype = None
vkCmdCopyImageToBuffer2KHR.argtypes = [VkCommandBuffer, ctypes.POINTER(VkCopyImageToBufferInfo2KHR)]
vkCmdResolveImage2KHR = VK_DLL.vkCmdResolveImage2KHR
vkCmdResolveImage2KHR.restype = None
vkCmdResolveImage2KHR.argtypes = [VkCommandBuffer, ctypes.POINTER(VkResolveImageInfo2KHR)]
vkCmdSetFragmentShadingRateKHR = VK_DLL.vkCmdSetFragmentShadingRateKHR
vkCmdSetFragmentShadingRateKHR.restype = None
vkCmdSetFragmentShadingRateKHR.argtypes = [VkCommandBuffer, ctypes.POINTER(VkExtent2D), (VkFragmentShadingRateCombinerOpKHR * (2))]
vkGetPhysicalDeviceFragmentShadingRatesKHR = VK_DLL.vkGetPhysicalDeviceFragmentShadingRatesKHR
vkGetPhysicalDeviceFragmentShadingRatesKHR.restype = VkResult
vkGetPhysicalDeviceFragmentShadingRatesKHR.argtypes = [VkPhysicalDevice, ctypes.POINTER(ctypes.c_uint32), ctypes.POINTER(VkPhysicalDeviceFragmentShadingRateKHR)]
vkCmdSetFragmentShadingRateEnumNV = VK_DLL.vkCmdSetFragmentShadingRateEnumNV
...
vkGetAccelerationStructureBuildSizesKHR = VK_DLL.vkGetAccelerationStructureBuildSizesKHR
vkGetAccelerationStructureBuildSizesKHR.restype = None
vkGetAccelerationStructureBuildSizesKHR.argtypes = [VkDevice, VkAccelerationStructureBuildTypeKHR, ctypes.POINTER(VkAccelerationStructureBuildGeometryInfoKHR), ctypes.POINTER(ctypes.c_uint32), ctypes.POINTER(VkAccelerationStructureBuildSizesInfoKHR)]
